...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      'client-directory-picker-flows BrowseDirectoryFlow',
      'client-directory-picker-flows NativeDirectoryFlow',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-conversation ChineseReasoningRow id \'chinese-reasoning\'',
      'client-ui-desktop-electron SoftwareInfoItem id \'software-information\'',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-desktop-electron RemoteAccessSection id \'remote-access\'',
  ...
  {
    key: 'sidebar.brand.badge',
    kind: 'list',
    scope: 'root',
    summary: 'Optional notification anchored to the top-left product mark.',
    doc: 'Optional notification anchored to the top-left product mark.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [
      'client-ui-desktop-electron UpdateBadge id \'desktop-update\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.brand.badge\', () => ctx.slots.register(\n      { name: \'sidebar.brand.badge\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
