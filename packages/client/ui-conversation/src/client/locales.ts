...
export const zh = {
  ...
  'settings.chineseReasoning.title': '中文思考与回复',
  'settings.chineseReasoning.description': '让模型默认使用中文思考和回复；用户明确指定其他语言时除外',
...
export const en = {
  ...
  'settings.chineseReasoning.title': 'Reason and reply in Chinese',
  'settings.chineseReasoning.description': 'Ask the model to use Chinese unless the user explicitly requests another language',
