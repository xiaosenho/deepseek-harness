...
export class SettingsDocumentStore {
  ...
  /**
   * @param api - Host-authorized settings wire face that reports and opens the provider document.
   */
 ...
 * @param controller - optional Host-authorized document state owner.
 */
