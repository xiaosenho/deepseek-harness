...
- **Commit by feature point.** One commit per functional change, each carrying its implementation, tests, docs, and Agent Note together. Every AI-driven change or requirement write lands as its own feature-point commit; keep unrelated work out of that commit.
