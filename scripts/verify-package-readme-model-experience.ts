...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/directory-picker-flows': { kind: 'none', reason: 'Shared browser directory-picker presentation library; registers nothing model-facing.' },
  'packages/client/ui-directory-picker-electron': { kind: 'none', reason: 'Browser-side surface routing loopback pages to the OS chooser and remote pages to the in-app browser; registers nothing model-facing.' },
  ...
  'packages/host/directory-picker-electron': { kind: 'none', reason: 'The Electron-host picking backend registers nothing model-facing.' },
